...
fprintf('----------------------------------------------------------------- \n');
fprintf('       PAERCA 1.0. Universidad Nacional de Colombia 2021          \n');
fprintf('----------------------------------------------------------------- \n');
fprintf('PORTRI/PAERCA: Analisis elastico lineal de pórticos tridimension. \n');
...
% ------------------------------------------------------------------------------  
  ...
  if TIPR==11 % barras 3D
    ...
    fprintf('\n');
    error('PAERCA. Este no es un problema de barras 3D.')
  end %endswitch
  TFIN = IMTIEM('',TINI);
